...
public class JsonRpc2_0NeoSwift: NeoSwift {
    ...
    init(config: NeoSwiftConfig, neoSwiftService: NeoSwiftService) {
        self.config = config
    ...
    public func getBestBlockHash() -> Request<NeoBlockHash, Hash256> {
        return .init(method: "", params: [], neoSwiftService: neoSwiftService)
    }
    ...
    public func termiateSession(_ sessionId: String) -> Request<NeoTerminateSession, Bool> {
    ...
    public func invokeContractVerify(_ contractHash: Hash160, _ methodParameters: [ContractParameter], _ signers: [Signer]) -> Request<NeoInvokeContractVerify, InvocationResult> {
        let signers = signers.map(TransactionSigner.init)
        return .init(method: "invokecontractverify", params: [contractHash, methodParameters, signers], neoSwiftService: neoSwiftService)
    }
    ...
    public func sendMany(_ from: Hash160, _ txSendTokens: [TransactionSendToken]) -> Request<NeoSendMany, Transaction> {
        return .init(method: "sendmany", params: [from, txSendTokens], neoSwiftService: neoSwiftService)
    }
    
    public func sendToAddress(_ tokenHash: Hash160, _ to: Hash160, _ amount: Int) -> Request<NeoSendToAddress, Transaction> {
        return .init(method: "sendtoaddress", params: [tokenHash.string, to.string, amount], neoSwiftService: neoSwiftService)
    }
    ...
    public func getProof(_ rootHash: Hash256, _ contractHash: Hash160, _ storageKeyHex: String) -> Request<NeoGetProof, String> {
        return .init(method: "getproof", params: [rootHash.string, contractHash.string, storageKeyHex], neoSwiftService: neoSwiftService)
    }
    
    public func verifyProof(_ rootHash: Hash256, _ proofDataHex: String) -> Request<NeoVerifyProof, String> {
        return .init(method: "verifyproof", params: [rootHash, proofDataHex.base64Encoded], neoSwiftService: neoSwiftService)
    }
    ...
    public func getState(_ rootHash: Hash256, _ contractHash: Hash160, _ keyHex: String) -> Request<NeoGetState, String> {
        return .init(method: "getstate", params: [rootHash.string, contractHash.string, keyHex], neoSwiftService: neoSwiftService)
    }
    ...
    public func findStates(_ rootHash: Hash256, _ contractHash: Hash160, _ keyPrefixHex: String, _ startKeyHex: String?, _ countFindResultItems: Int?) -> Request<NeoFindStates, NeoFindStates.States> {
        var parameters: [AnyHashable] = [rootHash, contractHash, keyPrefixHex.base64Encoded]
